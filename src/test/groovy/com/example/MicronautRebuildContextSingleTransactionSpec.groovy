...
@MicronautTest(rebuildContext = true, transactionMode = TransactionMode.SINGLE_TRANSACTION)
@Testcontainers
class MicronautRebuildContextSingleTransactionSpec extends Specification implements TestPropertyProvider {
